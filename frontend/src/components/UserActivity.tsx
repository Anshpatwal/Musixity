...
const UserActivity = () => {
    const { user } = useUser()
    const { fetchUsers, users, userActivities, onlineUsers } = useChatStore()
                ...
                <ScrollArea className="flex-1">
                    <div className='p-4 space-y-4'>
                        {users.map((user, index) => {
                            ...
                            return <div key={index} className='cursor-pointer hover:bg-zinc-800/50 p-3 rounded-md transition-colors group'>
